...
/**
 *  \defgroup   genrapports    GenRapports
 *  \brief      Générer des rapports personnalisés
 *  \file       htdocs/custom/genrapports/core/modGenRapports.class.php
 *  \ingroup    genrapports
 *  \brief      Fichier de description et activation du module GenRapports
 */
 ...
 */
class modGenRapports extends DolibarrModules
{
    /**
    ...
    public function __construct($db)
    {
        ...
        $this->numero = 300304;     // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'genrapports';
        ...
        $this->description = "Génération Rapports personnalisés";
        $this->descriptionlong = "Génération Rapports personnalisés Bilan / Compte de Résultat / Solde Intermédiaire de Gestion";
        $this->editor_name = 'Progiseize';
        $this->editor_url = 'https://progiseize.fr';
        
        // Possible values for version are: 'development', 'experimental', 'dolibarr', 'dolibarr_deprecated' or a version string like 'x.y.z'
        $this->version = '1.6.6';
        $this->url_last_version = "https://modules-api.progiseize.fr/modules/version/300304";
        ...
        $this->config_page_url = "setup.php@genrapports";
        ...
        $this->langfiles = array("genrapports@genrapports");
        ...
        $this->const = array(
            0=>array('GENRAPPORTS_NUMBERS_TO_USE','chaine','10','',1),
        );
        ...
        */
        ...
        $this->rights[$r][1] = 'Exécuter';    // Permission label
        $this->rights[$r][3] = 0;                    // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'executer';             // In php code, permission will be checked by test
        $r++;
        ...
        $this->rights[$r][3] = 0;                    // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'lire';             // In php code, permission will be checked by test
        $r++;
